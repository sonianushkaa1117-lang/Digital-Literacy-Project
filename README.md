...
The project also highlights the importance of responsible digital behavior and building a positive online presence.
...
* **Canva** – for designing infographics and presentations
* **Google Docs** – for writing and collaboration
* **Microsoft PowerPoint** – for presentations
* **GitHub** – for storing and managing projects

These tools help students work efficiently and creatively.
...
* Creating a professional profile (GitHub, LinkedIn)
* Sharing useful and relevant content
* Maintaining respectful and professional behavior online

A good online presence can create better academic and career opportunities.
...
Proper email etiquette improves communication skills and professionalism.

---

## 📎 Task 3 (Part B) – Google Form
...
* Gain knowledge about digital literacy
* Learn and use important digital tools
* Understand professional communication
* Create awareness among students through a Google Form
